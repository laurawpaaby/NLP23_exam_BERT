...
To execute this step, run the [`nb_BERT_large/nbL_OPTUNA_param_tune.ipynb`](https://github.com/laurawpaaby/NLP23_exam_BERT/blob/main/nb_large_model/nbL_OPTUNA_param_tune.ipynb).  
...
To execute this step, run the [`nb_BERT_large/nbL_Finetune_opt_param.ipynb`](https://github.com/laurawpaaby/NLP23_exam_BERT/blob/main/nb_large_model/nbL_Finetune_opt_param.ipynb). 
...
To execute this step, run the [`nb_BERT_large/nbL_pretrained_class.ipynb`](https://github.com/laurawpaaby/NLP23_exam_BERT/blob/main/nb_large_model/nbL_pretrained_class.ipynb). 
